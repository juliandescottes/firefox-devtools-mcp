...
- `--enable-debugging` — enable debugging tools: list scripts, inspect source, and set logpoints to observe expression values at runtime without pausing execution. Requires Firefox 153+ (`ENABLE_DEBUGGING=true`)
